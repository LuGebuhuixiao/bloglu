...
_accountSid = '8a216da86d05dc0b016d0c5f2b26024f'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '0c79b3012b2d456aa5fdcca8b310b331'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da86d05dc0b016d0c5f2b770255'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('15971466561', ['6666', 5], '1')
        if result == 0:
            print('短信验证码发送成功！')
            break
